...
<div class="container mt-5">
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <img src="images/pendiri.jpg" class="img-fluid rounded" alt="Foto Pendiri">
        </div>
        <div class="col-md-8">
            <h1>Biografi Pendiri</h1>
            <p>Pendiri Pesantren: K.H. M. Maliki Syafii</p>
            <p>
                <strong>A. Asal-usul</strong><br>
